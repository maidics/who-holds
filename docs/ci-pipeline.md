...
| 2.   | `ConfigurationRequirement`                                                                            | Always | Required environment variables must be set. Changes containing new environment variables should be added to string[] Required.                            |
